...
return(<div className="landing-main-container">

<div className="landing-first-image" style={landingFirstImage}>

  <div className="landing-page-greeting">
    <span>  Parking Sniffer is peer-to-peer website that allows you to search and reserve private parking spots across the US.</span>
  </div>
