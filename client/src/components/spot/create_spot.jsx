    ...
    render() {
        ...
        if (this.state.line1.length > 0 && this.state.city.length > 0 &&
            ...
            renderMap = <MyMapComponent 
                ...
                containerElement={<div className="myMapComponent" style={{ height: `400px`, width: `600px`, margin: `0px auto 0px auto`, borderRadius: `0px 0px 15px 15px`, boxShadow: `0px 3px 3px rgba(0, 0, 0, 0.5)` }} />} 
                mapElement={<div style={{ height: `100%`, borderRadius: `0px 0px 15px 15px` }} />} />;
        } else {
            renderMap = <h3 className="noMapComponent" style={{ height: `400px`, width: `600px`, margin: `0px auto 0px auto`, borderRadius: `0px 0px 15px 15px`, border: `1px solid black`, boxShadow: `0px 3px 3px rgba(0, 0, 0, 0.5)` }} />;
        }
        ...
        return <div className="create-spot-page">
            <div className="create-spot-form">
              <h2> Create a new Parking Spot </h2>

              <form>
                {this.state.img_url === null ? <div id="upload-image">
                    <span>Please upload a parking photo:</span>
                    <br />
                    <input type="file" onChange={e => this.setImg(e)} />
                  </div> : <div className="create-spot-main-img" style={imageStyle} />}

                <div className="Address">
                  <label> Address: </label>
                  <div id="building-street">
                    <input type="text" placeholder="Number" onChange={this.handleAddressChange("line1")} />
                ...
                <input id="submit-button" type="submit" onClick={e => this.handleSubmit(e)} value="Create Parking Spot" />
                </div>
