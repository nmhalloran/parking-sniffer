...
export const fetchReservations = id => dispatch =>
  ReservationAPIUtil.fetchReservations(id)
...
export const updateReservation = (spot_id, reservation) => dispatch =>
  ReservationAPIUtil.updateReservation(spot_id, reservation)
    .then(res => dispatch(receiveReservation(res)))
    .catch(err => console.log(err));
